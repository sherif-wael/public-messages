...
import {getMessagesByUsername} from "../../actions/messageActions";
...
const CurrentUserRecievedMessage = ({recievedMessages, loading, getMessagesByUsername, username}) => {
...
export default connect(mapStateToProps, {getMessagesByUsername})(CurrentUserRecievedMessage)