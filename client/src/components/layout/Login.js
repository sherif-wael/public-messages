...
const Login = ({login, history, setLoginForm}) => {
    ...
    return (
        <div className={classes.root}>
            ...
            <Divider />
            <Button color="primary" variant="contained"  onClick={() => window.location = "http://localhost:5000/api/auth/facebook"} className={classes.fbLink}><FacebookIcon className={classes.fbIcon} /> Login With Facebook</Button>
